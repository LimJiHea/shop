...
class ItemServiceTest {
    ...
    List<MultipartFile> createMultipartFiles() throws Exception{        //MockMultipartFile 클래스를 이용해 가짜 MultipartFile 리스트를 만들어 반환해주는 메소드

        List<MultipartFile> multipartFileList = new ArrayList<>();

        for(int i=0; i<5; i++){
            String path = "C:/LJH/shop/item/";
    ...
    void saveItem() throws Exception{
        ...
        //이미지는 첫 번째 파일의 원본 이미지 파일 이름만 같은지 확인함
